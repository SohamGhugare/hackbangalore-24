    ...
    <div className="w-[80%] text-center m-auto">
      <Tabs defaultValue="account" className="w-full">
        ...
        <TabsContent value="team">
          <div className="flex justify-center w-full gap-20">{members}</div>
        </TabsContent>
        <TabsContent value="updates">Change your password </TabsContent>
        <TabsContent value="fundings">
          <h1 className="text-start ml-2 text-xl font-bold mt-4 mb-2">Datavant Funding</h1>
          <div className="flex bg-zinc-200 rounded-lg p-4 gap-20 items-center mb-10">
            <div className="flex flex-col items-start">
              <h1 className="font-semibold text-sm text-slate-600">Valuation</h1>
              <h1>$10K</h1>
            </div>
            <div className="h-10 w-[1px] bg-slate-800 bg-opacity-50" />
            <div className="flex flex-col items-start">
              <h1 className="font-semibold text-sm text-slate-600">Funded Over</h1>
              <h1>2 rounds</h1>
            </div>
          </div>
        </TabsContent>
